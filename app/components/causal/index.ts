...
export const CausalFlowView = dynamic(() => import('./CausalFlowView'), {
...
export const TreeCausalGraph = dynamic(() => import('./TreeCausalGraph'), {
  loading: GraphLoadingPlaceholder,
  ssr: false,
});
...
export const TimelineCausalGraph = dynamic(() => import('./TimelineCausalGraph'), {
  loading: GraphLoadingPlaceholder,
  ssr: false,
});
