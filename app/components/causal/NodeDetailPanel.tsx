...
export default function NodeDetailPanel({
  ...
  const nodeTypeLabels: Record<string, { label: string; color: string }> = {
    event: { label: 'Evenement', color: '#DC2626' },
    entity: { label: 'Entite', color: '#2563EB' },
    decision: { label: 'Decision', color: '#D97706' },
    keyword: { label: 'Mot-cle', color: '#059669' },
  };
  ...
  return (
    <div style={styles.panel}>
      ...
      {incomingEdges.length > 0 && (
        <div style={styles.section}>
          <h4 style={styles.sectionTitle}>
            <span style={styles.sectionIcon}>&darr;</span>
      ...
      {outgoingEdges.length > 0 && (
        <div style={styles.section}>
          <h4 style={styles.sectionTitle}>
            <span style={styles.sectionIcon}>&uarr;</span>
