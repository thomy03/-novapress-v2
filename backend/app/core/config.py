...
class Settings(BaseSettings):
    ...
    STRIPE_PRO_MONTHLY_PRICE_ID: str = ""  # price_...
    STRIPE_PRO_ANNUAL_PRICE_ID: str = ""  # price_...
    STRIPE_ENTERPRISE_PRICE_ID: str = ""  # price_...
...
settings = Settings()
# Rotating User-Agents to bypass scraping blocks
USER_AGENTS = [
    # Chrome Windows
